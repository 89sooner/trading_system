...
import { trainPatterns, savePatternSet } from '@/api/patterns'
...
export function PatternTrainForm() {
  ...
  return (
    <div className="space-y-4">
      <form onSubmit={handleTrain} className="grid grid-cols-2 gap-3">
        ...
        <div className="col-span-2 flex items-center gap-2">
          ...
          <Button
            type="button"
            variant="bull"
            disabled={!latestPreview || isSaving}
            onClick={handleSave}
          >
          ...
          {savedId && (
            <Link
              to="/patterns/$patternSetId"
              params={{ patternSetId: savedId }}
